        ...
        <div class="col-xs-6">
            <table>
                ...
                <tr>
                    ...
                    <td><h4><fmt:formatDate value="${excursion.dateFrom}" type="date" dateStyle="medium"/></h4></td>
                </tr>
                <tr>
                    <td><h4>Date to:</h4></td>
                    <td><h4><fmt:formatDate value="${excursion.dateTo}" type="date" dateStyle="medium"/></h4></td>
                </tr>
                <tr>
