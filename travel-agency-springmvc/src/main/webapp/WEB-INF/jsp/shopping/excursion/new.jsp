...
<jsp:attribute name="body">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/shopping/excursion/create"
        ...
        <div class="form-group ${description_error?'has-error':''}">
            ...
            <form:label path="dateFrom" cssClass="col-sm-2 control-label">Date from (yyyy-mm-dd)</form:label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <form:label path="dateTo" cssClass="col-sm-2 control-label">Date to (yyyy-mm-dd)</form:label>
            <div class="col-sm-10">
